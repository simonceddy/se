export default {
    contact: {
        ...
        Email: <a href="mailto:simon@simoneddy.com.au">simon@simoneddy.com.au</a><br><br>
    `
    },
    services: {
        title: '',
...
to book a visit).<br><br>
 <br><br>
Simon also offers audio engineering services (please <a href="./contact">Contact Simon</a> for more information).<br><br>
